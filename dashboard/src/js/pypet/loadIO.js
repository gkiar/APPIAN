...
function menuQC(xmlNodes){
    ...
    subScan.innerHTML="<a href=\"javascript:;\" onclick=\"coregPageGp()\">GroupQC</a>";
...
//    
//    $divRow.append($divPet);
//    $divPet.append($divBox);
//    $divBox.append($divHdr);
//    $divHdr.append($("<h5>").text("PET"));
...
//                        if ((image.nodeType == 1) && 
//                            (image.nodeName == "in_source_mask") || (image.nodeName == "in_source_file")) {
...
//    $divBody = $("<div>", {'class': "body"});
//    
//    $divRow.append($divMri);
//    $divMri.append($divBox);
//    $divBox.append($divHdr);
//    $divHdr.append($("<h5>").text("MRI"));
//    $divTlb.append($("<img>").attr("src","img/ajax-loader.gif"));
//    $divHdr.append($divTlb);
//    bb="brainbrowserMRI";
//    $divBody.append($("<div>", {'id':bb}));
...
//                    while(k<details.childNodes.length){
//                        if ((image.nodeType == 1) && 
//                            (image.nodeName == "in_target_mask") || (image.nodeName == "in_target_file")) {
//                            overlayFiles.push(image.textContent);
//                        }
//                        image=image.nextSibling;
//                        k++;
